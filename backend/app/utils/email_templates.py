...
def template_observaciones_completas(nombre: str, programa: str, docs_observados: list, link_edicion: str, numero_documento: str = None, nombre_funcionario: str = None, correo_funcionario: str = None, observaciones_generales: str = None) -> str:
    docs_html = ""
    if docs_observados:
        items = "".join([
