...
CREATE TABLE `solicitudes` (
  ...
  `estado_actual` enum('PENDIENTE_REVISION','CON_OBSERVACIONES','CORREGIDO','PENDIENTE_FIRMAS','PENDIENTE_CERTIFICACION','RECHAZADO','CERTIFICADO') NOT NULL DEFAULT 'PENDIENTE_REVISION',
...
CREATE TABLE `estados_historial` (
  `id` int NOT NULL AUTO_INCREMENT,
  `solicitud_id` int NOT NULL,
  `estado_anterior` enum('PENDIENTE_REVISION','CON_OBSERVACIONES','CORREGIDO','PENDIENTE_FIRMAS','PENDIENTE_CERTIFICACION','RECHAZADO','CERTIFICADO') DEFAULT NULL,
