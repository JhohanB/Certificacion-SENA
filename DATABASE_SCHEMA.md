...
CREATE TABLE solicitudes (
  ...
  estado_actual ENUM('PENDIENTE_REVISION','CON_OBSERVACIONES','CORREGIDO','PENDIENTE_FIRMAS','PENDIENTE_CERTIFICACION','CERTIFICADO') DEFAULT 'PENDIENTE_REVISION',
...
CREATE TABLE estados_historial (
  id INT PRIMARY KEY AUTO_INCREMENT,
  solicitud_id INT NOT NULL,
  estado_anterior ENUM('PENDIENTE_REVISION','CON_OBSERVACIONES','CORREGIDO','PENDIENTE_FIRMAS','PENDIENTE_CERTIFICACION','CERTIFICADO'),
