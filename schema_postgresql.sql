...
CREATE TABLE solicitudes (
  ...
  estado_actual VARCHAR(50) NOT NULL DEFAULT 'PENDIENTE_REVISION'
    CHECK (estado_actual IN ('PENDIENTE_REVISION','CON_OBSERVACIONES','CORREGIDO','PENDIENTE_FIRMAS','PENDIENTE_CERTIFICACION','RECHAZADO','CERTIFICADO')),
...
CREATE TABLE estados_historial (
  ...
  estado_anterior VARCHAR(50)
    CHECK (estado_anterior IS NULL OR estado_anterior IN ('PENDIENTE_REVISION','CON_OBSERVACIONES','CORREGIDO','PENDIENTE_FIRMAS','PENDIENTE_CERTIFICACION','RECHAZADO','CERTIFICADO')),
  estado_nuevo VARCHAR(50) NOT NULL
    CHECK (estado_nuevo IN ('PENDIENTE_REVISION','CON_OBSERVACIONES','CORREGIDO','PENDIENTE_FIRMAS','PENDIENTE_CERTIFICACION','RECHAZADO','CERTIFICADO')),
  usuario_id INTEGER REFERENCES usuarios(id),
  motivo TEXT,
