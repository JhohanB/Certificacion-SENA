...
import { DashboardOutlined, FileTextOutlined, UserOutlined, TeamOutlined, SettingOutlined, AuditOutlined, BarChartOutlined, LogoutOutlined, MenuOutlined, KeyOutlined } from '@ant-design/icons'
