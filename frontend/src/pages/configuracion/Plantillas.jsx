...
import { Table, Button, Card, Typography, Tag, Space, Modal, message, Alert, Divider, Popconfirm, Select } from 'antd'
...
function EditorCoordenadas({ plantilla, open, onClose, onGuardado }) {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div className="editor-coords-container">
        {/* Panel izquierdo — controles */}
        <div className="editor-coords-panel">
        ...
        <div ref={containerRef} className="editor-coords-canvas">
          <canvas
            ref={canvasRef}
            style={{
