    ...
    <div>
      <style>{`
        @media (max-width: 768px) {
          ...
          .solicitudes-buttons .ant-btn {
            flex: 0 1 auto;
            min-width: 90px;
          }
        }
      `}</style>
      <div className="solicitudes-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, gap: 8, flexWrap: 'wrap' }}>
        <Title level={4} style={{ margin: 0 }}>Solicitudes</Title>
        <Space className="solicitudes-buttons" style={{ display: 'flex', flexWrap: 'wrap', gap: 8, justifyContent: 'flex-end' }}>
          ...
          {tieneAccesoCompleto && (
            <>
              ...
              >
                {modoEliminar ? 'Cancelar' : 'Eliminar docs'}
              </Button>
              ...
              >
                Descargar ({certificadosVisibles.length})
              </Button>
              ...
              {modoEliminar && (
                ...
                >
                  Confirmar ({seleccionadasEliminar.length})
                </Button>
              )}
            </>
          )}
